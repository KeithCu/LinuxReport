...
Generated by <a href="https://openrouter.ai/{{ model_name }}" target="_blank" style="text-decoration: none;">{{ model_name }}</a>
</div>
</div>
<br/>
""")
...
def generate_headlines_html(top_articles, output_file, model_name=None):
    ...
    Args:
        ...
        model_name: Name of the AI model used to generate headlines
    """
    ...
    for idx, art in enumerate(top_articles[:3]):
        rendered_html = headline_template.render(
            ...
            model_name=model_name or "qwen/qwen3-235b-a22b"  # Default to Qwen if no model specified
        )
